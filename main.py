...
# CodeGrade step7
# Replace None with your code
df_hungry_ages = pd.read_sql("""SELECT name, age, hungry FROM dogs WHERE hungry = 1 AND 2<age<8  ORDER BY name ASC;""", conn2)
...
df_teams_years = pd.read_sql("""
    SELECT team, COUNT(DISTINCT year) AS years_played
    FROM babe_ruth_stats
    GROUP BY team;
""", conn3)
